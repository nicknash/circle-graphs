...
namespace
{
    ...
    int mifRscanSize(const std::vector<cgtd::Interval> &intervals)
    {
        cgtd::DistinctIntervalModel model(intervals);
        return cg::mif::MifRscanN5Qspace::computeMifSize(model);
    }

    std::pair<int, std::vector<cgtd::Interval>> mifRscanSolution(const std::vector<cgtd::Interval> &intervals)
    {
        cgtd::DistinctIntervalModel model(intervals);
        return cg::mif::MifRscanN5Qspace::computeMif(model);
    }
}

TEST_CASE("[MifRscanN5Qspace] Single edge is fully kept")
{
    std::vector<cgtd::Interval> intervals;
    ...
    CHECK(expected == 2);
    const auto [size, pickedIntervals] = mifRscanSolution(intervals);
    CHECK(size == expected);
    CHECK(static_cast<int>(pickedIntervals.size()) == expected);
    CHECK(isForestInduced(intervals, extractIndices(pickedIntervals)));
    CHECK(mifRscanSize(intervals) == size);
}

TEST_CASE("[MifRscanN5Qspace] Single dummy left child")
{
    std::vector<cgtd::Interval> intervals;
...
TEST_CASE("[MifRscanN5Qspace] Three nested intervals")
{
    std::vector<cgtd::Interval> intervals;
...
TEST_CASE("[MifRscanN5Qspace] Four nested intervals")
{
    std::vector<cgtd::Interval> intervals;
...
TEST_CASE("[MifRscanN5Qspace] Two disjoint intervals")
{
    std::vector<cgtd::Interval> intervals;
...
TEST_CASE("[MifRscanN5Qspace] Three disjoint intervals")
{
    std::vector<cgtd::Interval> intervals;
    intervals.push_back(mk(0, 1, 0));
    intervals.push_back(mk(2, 3, 1));
...
TEST_CASE("[MifRscanN5Qspace] Single interval containing two disjoint")
{
    std::vector<cgtd::Interval> intervals;
    intervals.push_back(mk(0, 5, 0));
    intervals.push_back(mk(1, 2, 1));
...
TEST_CASE("[MifRscanN5Qspace] Single interval containing three disjoint")
{
    std::vector<cgtd::Interval> intervals;
    intervals.push_back(mk(0, 7, 0));
    intervals.push_back(mk(1, 2, 1));
...
TEST_CASE("[MifRscanN5Qspace] Triangle reduces to 2")
{
    std::vector<cgtd::Interval> intervals;
    intervals.push_back(mk(0, 3, 0));
    intervals.push_back(mk(1, 4, 1));
...
TEST_CASE("[MifRscanN5Qspace] Disconnected forest stays whole")
{
    std::vector<cgtd::Interval> intervals;
    intervals.push_back(mk(0, 2, 0));
    intervals.push_back(mk(1, 3, 1));
...
TEST_CASE("[MifRscanN5Qspace] Triangle plus edge")
{
    std::vector<cgtd::Interval> intervals;
    intervals.push_back(mk(0, 3, 0));
    intervals.push_back(mk(1, 4, 1));
...
TEST_CASE("[MifRscanN5Qspace] Mixed nested + overlaps")
{
    std::vector<cgtd::Interval> intervals;
...
TEST_CASE("[MifRscanN5Qspace] Left and right dummies right dummy first")
{
    std::vector<cgtd::Interval> intervals;
    intervals.push_back(mk(0, 1, 0));
    intervals.push_back(mk(2, 5, 1));
...
TEST_CASE("[MifRscanN5Qspace] Left and right dummies left dummy first")
{
    std::vector<cgtd::Interval> intervals;
    intervals.push_back(mk(0, 3, 0));
    intervals.push_back(mk(1, 2, 1));
...
TEST_CASE("[MifRscanN5Qspace] Random small instances match brute force (n<=9)")
{
